...
![Figure 4. Site and Methods sub-schema. ~ indicate unique keys for the database.](images/EvergladesDatabase-SiteandMethods.png)
...
![Figure 5. Counts sub-schema.](images/EvergladesDatabase-Counts.png)
...
![Figure 6. Nesting sub-schema.](images/EvergladesDatabase-Nesting.png)
...
![Figure 7. Feather mercury sub-schema.](images/EvergladesDatabase-Hg.png)

* feather_hg.csv: Measurements for Hg levels in individual feathers.

## Indicators

![Figure 8. Indicators sub-schema.](images/EvergladesDatabase-Indicators.png)
...
![Figure 9. Historic sub-schema.](images/EvergladesDatabase-Historic.png)
...
![Figure 10. Weather sub-schema.](images/EvergladesDatabase-Weather.png)
