...
![Figure 8. Overall database schema for the entire database showing how datafiles relate to each other. Listed fields are the keys or unique identifiers for a table. The name of each directory (e.g., COUNTS) is color-coded and located in each dotted outlined box.](../images/EvergladesDatabase-Overview.png)
...
![Figure 9. Site and Methods sub-schema. ~ indicate unique keys for the database.](../images/EvergladesDatasets-SiteandMethods.png)
...
![Figure 10. Counts sub-schema.](../images/EvergladesDatasets-Counts.png)
...
![Figure 11. Nesting sub-schema.](../images/EvergladesDatasets-Nesting.png)
...
![Figure 12. Feather mercury sub-schema.](../images/EvergladesDatasets-Hg.png)

* feather_hg.csv: Measurements for Hg levels in individual feathers.

## Indicators

![Figure 13. Indicators sub-schema.](../images/EvergladesDatasets-Indicators.png)
...
![Figure 14. Historic sub-schema.](../images/EvergladesDatasets-Historic.png)
...
![Figure 15. Weather sub-schema.](../images/EvergladesDatasets-Weather.png)
