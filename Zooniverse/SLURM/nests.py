#!/bin/bash
#SBATCH --job-name=nest_everglades   # Job name
...
#SBATCH --output=/home/b.weinstein/logs/everglades_nest_predict%j.out   # Standard output and error log
#SBATCH --error=/home/b.weinstein/logs/everglades_nest_predict%j.err
