...
\newpage
```{r map, echo=FALSE, fig.cap="Locations of nesting wading bird colonies totaling over 40 pairs", fig.width=6, fig.height=6.5, message=FALSE, warning=FALSE}
...
```{r storkindicator, echo=FALSE, fig.cap="Wood Stork nest initiation date in the Everglades of Florida.", fig.height=2.5, fig.width=5, message=FALSE, warning=FALSE}
