...
The `r params$report_year` season [describe water levels, weather, water recession]
...
While overall nest success was exceptionally poor across species in `r params$report_year`, [describe overall nest success and nesting conditions]
...
At the start of `r params$report_year` 

[describe water levels and changes]

(Figures \@ref(fig:waterplot3) - \@ref(fig:waterplotcoastal)).
...
In `r params$report_year` water recession rates  

[describe recession and effect on nesting]
...
The `r params$report_year` season experienced wide fluctuations. 

[describe temperature and effect on prey availability] (Figure \@ref(fig:temperature)).

[describe rainfall and effect on prey availability and nest success] (Figure \@ref(fig:precipitation)).
...
Black-crowned Night Herons are likely to be a predator on nestlings of *Egretta* herons; the night herons have been increasing as nesters, roosters, and foragers rapidly during the past ten years. Black-crowned Night Herons have rebounded from last year's low numbers, with `r totals$bcnh` adults counted during ground surveys in `r params$report_year` (Figure \@ref(fig:groundplot)).
...
The `r params$report_year` nesting effort (`r total_nests` nest starts) was 

[summarise year]

(Table \@ref(tab:effortsummarytable))

(Table \@ref(tab:successsummarytable))
